...
assert.equal(engine.getNextInterval(100, 15, 1, 9), 15, "menos de 10 questões não avança");
assert.equal(engine.getNextInterval(90, 15, 1, 10), 30, "90% com 10 questões avança um estágio");
